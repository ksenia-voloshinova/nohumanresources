        ...
        <nav className={`${styles.nav}`}>
            <div className="container">
                <div className={styles.wrapp}>
                    <div>
                        <Image className={`${styles.logo} ${styles.imgBlack}`} src={logoNav}  loading="lazy" alt="picture"/>
                        <Image className={`${styles.logo} ${styles.imgWhite}`} src={logoNavWhite}  loading="lazy" alt="picture"/>
                    </div>
