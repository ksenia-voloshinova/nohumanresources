        ...
        <div className={styles.section}>
            <div className="container">
                ...
                <div className={styles.grid__articles}>
                    <div className={`${styles.card_article} ${styles.border_black}`}>
                    ...
                    <div className={`${styles.card_article} ${styles.border_red}`}>
                ...
                <div className={styles.grid__articles}>
                    <div className={`${styles.secondRow__card_article} ${styles.border_red}`}>
                        <div className={styles.wrapp__content}>
                    ...
                    <div className={`${styles.secondRow__card_article} ${styles.border_black}`}>
                        <div className={styles.wrapp__content}>
